...
def add_cart(request, product_id):
    ...
    if request.method == 'POST':
        for item in request.POST:
            ...
            try:
                variation = Variation.objects.get(product=product,variation_category__iexact=key, variation_value__iexact=value) #ignore if key is cap or lower
    ...
    if is_cart_item_exists:        
        ...
        print(product_variation, "oooooooo", ex_var_list)
